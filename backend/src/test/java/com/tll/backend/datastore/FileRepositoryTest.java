...
public class FileRepositoryTest {
    ...
    public void ValidTest() throws IOException {
        List<Barang> barangList = List.of(
                new Barang(0, 100, "Buku", new BigDecimal(1000), new BigDecimal(800), new KategoriBarang(0, "kat1"), "test.com", true),
                new Barang(1, 100, "Pensil", new BigDecimal(2000), new BigDecimal(1500), new KategoriBarang(1, "kat2"), "test2.com", true),
                new Barang(2, 100, "Penghapus", new BigDecimal(500), new BigDecimal(400), new KategoriBarang(2, "kat3"), "test3.com", true)
        );
